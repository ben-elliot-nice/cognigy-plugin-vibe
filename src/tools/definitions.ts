    ...
    inputSchema: {
      ...
      properties: {
        ...
        forceWrite: {
          type: "boolean",
          description:
            'update only: overwrite even when write-conflict detection blocked the write (remote content differs from what this tool last pushed — see the "conflict"/"diff" fields in a blocked response). Default: false.',
        },
        focus: {
          oneOf: [
            { type: "string" },
